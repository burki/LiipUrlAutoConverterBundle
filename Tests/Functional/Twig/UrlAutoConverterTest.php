...
class UrlAutoConverterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        if (method_exists('\Twig\Environment', 'createTemplate')) { // twig > 3.0
        ...
        } else if (method_exists('\Twig\Environment', 'createTemplate')) { // twig > 2.0
            $twig = new \Twig\Environment(new \Twig_Loader_Array());
            $twig->addExtension(new UrlAutoConverterTwigExtension());
